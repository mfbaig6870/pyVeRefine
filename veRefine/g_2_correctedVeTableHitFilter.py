...
hit_count_df = pd.read_csv('../outputs/logHitCountThreshold.csv', skiprows=0, index_col=0)
...
# Apply a filter where the value is greater than 10
avg_afr_delta_df = avg_afr_delta_df * hit_count_df
...
result.to_csv("../outputs/correctedVeTable.csv", index=True, header=True)
